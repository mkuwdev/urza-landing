  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Link href="">
          <div className="mt-4">
            <div class="relative group overflow-hidden px-6 h-12 rounded-full flex space-x-2 items-center bg-gradient-to-r from-pink-500 to-purple-500 hover:to-purple-600 hover:cursor-pointer">
              <span class="relative text-sm text-white font-bold font-mono">Get Started</span>
